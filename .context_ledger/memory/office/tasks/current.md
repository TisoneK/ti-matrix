...
- **Next up:** decide what "fixing where possible" covers next — more builtin-path edge cases, or the two known open items surfaced along the way (B-2026-09-23-5's small-model weakness, B-2026-09-23-2's thin prose-world panels) are live candidates.
