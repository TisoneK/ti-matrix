...
- **Also queued (user, same conversation):** B-2026-09-23-7 — show the page the browser world is driving, and what the run actually saw of it. Smaller and mostly wiring; the engine already writes the screenshots. Brief: `.context_ledger/memory/office/plans/browser-what-it-sees-brief.md`.
