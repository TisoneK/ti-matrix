...
- **Open items:** paused to report to the user before deciding what "fixing where possible" covers next (a real hosted DeepSeek run to exercise `fetch_balance()` against a live account is still unverified; B-2026-09-23-5 and B-2026-09-23-2 are older, still-open findings this session did not touch).
- **Notes:** none
- **Report:** none (not a review task)
