...
- **Open items:** B-2026-09-23-5 and B-2026-09-23-2 are older, still-open findings this session did not touch; deciding with the user what "fixing where possible" covers next.
- **Notes:** none
- **Report:** none (not a review task)
