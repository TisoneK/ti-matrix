...
- **Open items:** B-2026-09-23-5 and B-2026-09-23-2 are older, still-open findings this session did not touch; whether the drawer pass satisfies "the entire ui" or more screens need the same treatment is still open with the user.
- **Notes:** none
- **Report:** none (not a review task)
