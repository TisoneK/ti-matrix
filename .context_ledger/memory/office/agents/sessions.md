...
- **Open items:** B-2026-09-23-5 and B-2026-09-23-2 are older, still-open findings this session did not touch; the user separately called the settings-drawer *structure* bad (beyond the models fix) — not yet scoped; deciding with the user what to do next.
- **Notes:** none
- **Report:** none (not a review task)
